...
function SignUp() {
    ...
    <div className='h-[calc(100vh-60px)] w-[100vw] bg-[var(--ternary)] flex items-center justify-center' > 
            <div className='h-[70vh] w-[65vh] bg-[var(--background-2)] rounded-md flex flex-col justify-start items-center gap-4 p-3'>
                ...
                <div className='h-[50px] w-[80%] bg-[var(--ternary)] text-white flex justify-center items-center rounded-[5px]'>
                ...
                <input type="text" className='h-[50px] w-[80%] border border-[--secondary] bg-[var(--background-2)] rounded-[5px] p-4 text-[--primary]' placeholder='Enter your email' name='email' value={formdata.email} onChange={updateForm}/>

                <div className='h-[50px] w-[80%] bg-[var(--secondary)] text-black flex justify-center items-center rounded-[5px]'>Continue with email</div>
